...
import c.zju.jianshu.adapter.BookRecyclerAdapter;
import c.zju.jianshu.app.MyApplication;
...
public class SearchActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(c.zju.jianshu.R.layout.activity_search);
        ...
        swipeRefreshLayout.setColorSchemeResources(c.zju.jianshu.R.color.google_blue, c.zju.jianshu.R.color.google_red, c.zju.jianshu.R.color.google_green, c.zju.jianshu.R.color.google_yellow);
    ...
    public void search() {
        if (!etSearch.getText().toString().trim().isEmpty()) {
            ...
            Toasty.info(getApplicationContext(), "请输入你想要搜索的书名", Toast.LENGTH_SHORT, true).show();
    ...
    public void get() {
        if (search_type == SEARCH_LOCAL) {
            ...
            if (books.size() == 0) {
                Toasty.info(getApplicationContext(), "本地尚未有这本图书", Toast.LENGTH_SHORT, true).show();
            }
                ...
                DataManager.getBookSearch(searchBookName, adapter.getItemCount(), new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (total == 0) {
                                Toasty.info(getApplicationContext(), "未能找到该书籍的信息", Toast.LENGTH_SHORT, true).show();
                                total = 10;
                            }
