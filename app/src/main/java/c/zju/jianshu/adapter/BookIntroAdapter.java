...
import c.zju.jianshu.model.bean.TagItem;
...
public class BookIntroAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(c.zju.jianshu.R.layout.fragment_book_intro_item, null);
            holder = new BookIntroViewHolder();
            holder.tvTag = (TextView) convertView.findViewById(c.zju.jianshu.R.id.tag);
            holder.tvContent = (TextView) convertView.findViewById(c.zju.jianshu.R.id.content);
